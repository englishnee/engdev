...
public class MemberController {
	...
	public String kakaoLogin(@RequestParam("code") String code, HttpSession session, HttpServletRequest request, KakaoVO vo) throws Exception {
		
		System.out.println(code);
		
		String access_Token = kakao.getAccessToken(code);
		KakaoVO userInfo = kakao.getUserInfo(access_Token);
		KakaoVO login = new KakaoVO();
		
		String nickname = "";
		String[] id = userInfo.getAccount_email().split("@");
		
		login.setNickname(nickname);
		login.setAccount_email(id);
